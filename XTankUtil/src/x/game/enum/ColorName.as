package x.game.enum
{
    ...
    public class ColorName
    {
        ...
        public static const AQUA:ColorName = new ColorName("浅绿色", 0x00FFFF);
        public static const BLACK:ColorName = new ColorName("黑色", 0x000000);
        public static const BLUE:ColorName = new ColorName("蓝色", 0x0000FF);
        public static const FUCHSIA:ColorName = new ColorName("紫红色", 0xFF00FF);
        public static const GRAY:ColorName = new ColorName("灰色", 0x808080);
        public static const GREEN:ColorName = new ColorName("绿色", 0x008000);
        public static const LIME:ColorName = new ColorName("绿黄色", 0x00FF00);
        public static const MAROON:ColorName = new ColorName("褐红色", 0x800000);
        public static const NAVY:ColorName = new ColorName("深蓝色", 0x000080);
        public static const OLIVE:ColorName = new ColorName("橄榄色", 0x808000);
        public static const PURPLE:ColorName = new ColorName("紫色", 0x800080);
        public static const RED:ColorName = new ColorName(" 红色", 0xFF0000);
        public static const SILVER:ColorName = new ColorName("银色", 0xC0C0C0);
        public static const TEAL:ColorName = new ColorName("青色", 0x008080);
        public static const WHITE:ColorName = new ColorName("白色", 0xFFFFFF);
        public static const YELLOW:ColorName = new ColorName("黄色", 0xFFFF00);
