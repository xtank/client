package onlineproto {
	...
	public dynamic final class cs_select_team extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const TEAMID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("onlineproto.cs_select_team.teamid", "teamid", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (teamid$count != 0) {
						throw new flash.errors.IOError('Bad data format: cs_select_team.teamid cannot be set twice.');
					}
					++teamid$count;
