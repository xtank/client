package
{
	...
	public class XTankLogin extends Sprite
	{
		...
		private function initComponent():void
		{
			...
			_accountInputTxt.text = String(Random.random(10,99) * 10000) ;
				//String(ArrayUtilities.getRandomElement(_testAccounts));
			//
			...
			//
			var nodeDescription:String = KeyValueTextNode.NODE_Name + BaseNode.NODE_START_TAG + "名字1" + BaseNode.NODE_KEY_TAG + "测试1" + BaseNode.NODE_END_TAG + KeyValueTextNode.NODE_Name + BaseNode.NODE_START_TAG + "名字2" + BaseNode.NODE_KEY_TAG + "测试2";
