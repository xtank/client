package onlineproto {
	...
	public dynamic final class sc_enter_server extends com.netease.protobuf.Message {
		/**
		 *  @private
		 */
		public static const USERID:FieldDescriptor$TYPE_UINT32 = new FieldDescriptor$TYPE_UINT32("onlineproto.sc_enter_server.userid", "userid", (1 << 3) | com.netease.protobuf.WireType.VARINT);
		...
		override com.netease.protobuf.used_by_generated_code final function readFromSlice(input:flash.utils.IDataInput, bytesAfterSlice:uint):void {
			...
			while (input.bytesAvailable > bytesAfterSlice) {
				...
				case 1:
					if (userid$count != 0) {
						throw new flash.errors.IOError('Bad data format: sc_enter_server.userid cannot be set twice.');
					}
					++userid$count;
