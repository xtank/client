...
package x.game.util
{
    ...
    public class DisplayObjectFilter
    {
         ...
         */
        private static const DIGITAL_NEGATIVE_MATRIX:Array = [-1, 0, 0, 0, 255, 0, -1, 0, 0, 255, 0, 0, -1, 0, 255, 0, 0, 0, 1, 1];
         ...
         */
        private static const GRAY_SCALE_MATRIX:Array = [0.3086, 0.6094, 0.0820, 0, 0, 0.3086, 0.6094, 0.0820, 0, 0, 0.3086, 0.6094, 0.0820, 0, 0, 0, 0, 0, 1, 0];
         ...
         */
        private static const EDGE_DETECT_MATRIX:Array = [0, -1, 0, -1, 4, -1, 0, -1, 0];
         ...
         */
        private static const SHARPEN_MATRIX:Array = [0, -1, 0, -1, 5, -1, 0, -1, 0];
        ...
        {
            return [-value, -1, 0, -1, 1, 1, 0, 1, value];
        }
        ...
        {
            var oldPictureMatrix:Array = [0.94, 0, 0, 0, 0, 0, 0.9, 0, 0, 0, 0, 0, 0.8, 0, 0, 0, 0, 0, 0.8, 0];
            var returnBitmapData:BitmapData = source.clone();
