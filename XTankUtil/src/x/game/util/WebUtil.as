package x.game.util
{
    ...
    public class WebUtil
    {
        ...
        public static function openQQ(qq:uint):void
        {
            navigateToURL(new URLRequest("tencent://Message/?uin=" + qq + "&websiteName=q-zone.qq.com&Menu=yes"), "_self");
        }
        ...
        public static function BrowserMatch():Object
        {
            ...
            var match:Object = regWebkit.exec(ua) || ropera.exec(ua) || rmsie.exec(ua) || ua.indexOf("compatible") < 0 && rmozilla.
                exec(ua) || [];
